...
% changes:  added vertical figure export
...
%% A) plot in 'vertical figure'
% create figure
figure('Position',[1,1,500,750]);

% create axes for subfigure A
axes('Position',[0.15 0.56 0.75 0.39]);
...
%% B) plot output power in 'horizontal' figure
% pull up figure
figure(1);
...
%% B) plot output power a in 'vertical' figure
% pull up figure 2
figure(2);

% create axes for subplot
axes('Position',[0.15 0.07 0.75 0.39]);
...
text(0.1,0.268,'$f_1 = 2.8$','FontSize',fS,'Interpreter','latex','horizontalAlignment','center');
text(0.1,0.178,'$f_1 = 1.3$','FontSize',fS,'Interpreter','latex','horizontalAlignment','center');
text(0.1,0.115,'$f_1 = 1$','FontSize',fS,'Interpreter','latex','horizontalAlignment','center');
% add legend
legend({'$V_\mathrm{t}(x) = \frac{1}{2}x^2$','$f_2=1$','$f_2=0.1$','$f_2=0.01$'},'location','southwest');
% set font size
set(gca,'FontSize',fS);
...
% save figure
saveas(gcf, '../../doc/quadratic_to_linear_vertical','epsc')
